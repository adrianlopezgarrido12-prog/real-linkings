...
const selectClass =
  'min-h-11 w-full rounded-xl border border-white/15 bg-[#1b3556] px-3.5 text-sm text-[#f7fbff] outline-none transition focus:border-[#b8d5ff]/65'
const inputClass =
  'min-h-11 w-full rounded-xl border border-white/15 bg-white/[0.06] px-3.5 text-sm text-[#f7fbff] outline-none transition placeholder:text-white/28 focus:border-[#b8d5ff]/65'
  ...
  const skipButton = (
    <div className="mb-3 flex justify-end sm:absolute sm:right-0 sm:top-0 sm:mb-0">
      <button
        type="button"
        onClick={onSkip}
        className="rounded-full border border-[#b8d5ff]/25 bg-[#172f4d]/55 px-3 py-2 text-[0.62rem] font-semibold uppercase tracking-[0.11em] text-[#c7dcff] backdrop-blur-md transition hover:border-[#b8d5ff]/55 hover:text-white"
      >
  ...
  if (view === 'astrology') {
    return (
      <div className="relative flex h-full flex-col justify-center">
        {skipButton}
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#b8d5ff]">
          Astrología · Una referencia opcional
        </p>
        <h1 className="mt-2 max-w-3xl font-serif text-3xl text-[#f7fbff] sm:mt-3 sm:text-5xl">
          Empieza por aquello que ya conozcas.
        </h1>
        <p className="mt-4 max-w-2xl text-sm leading-6 text-[#f7fbff]/60">
        ...
        <div className="mt-7 grid gap-4 sm:grid-cols-3">
          {[
            ...
            >
              <span className="mb-2 block text-xs text-[#f7fbff]/60">
                {label}
              </span>
              <select
                value={
  ...
  if (view === 'personality') {
    return (
      <div className="relative flex h-full flex-col justify-center">
        ...
        <h1 className="mt-3 font-serif text-3xl text-[#f7fbff] sm:text-5xl">
        ...
        <div className="mt-2 grid gap-2.5 sm:mt-6 sm:gap-4 lg:grid-cols-[0.7fr_1.3fr]">
          <section className="rounded-2xl border border-white/12 bg-white/[0.045] p-4 sm:p-5">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#b8d5ff]">
              MBTI
            </p>
            <p className="mt-2 text-xs leading-5 text-[#f7fbff]/52">
  ...
  if (view === 'documents') {
    return (
      <div className="relative flex h-full flex-col justify-center">
        ...
        <h1 className="mt-2 font-serif text-2xl text-[#f7fbff] sm:mt-3 sm:text-5xl">
    ...
    <div className="relative flex h-full flex-col justify-center">
      ...
      <div className="mt-4">
        <label className="block rounded-2xl border border-white/12 bg-white/[0.045] p-4">
          <span className="text-xs font-semibold uppercase tracking-[0.12em] text-[#b8d5ff]">
            Notas simbólicas
          </span>
          <textarea
            ...
            className="mt-3 w-full resize-none rounded-xl border border-white/15 bg-white/[0.06] px-3.5 py-3 text-xs leading-5 text-[#f7fbff] outline-none placeholder:text-white/28 focus:border-[#b8d5ff]/65"
          />
        </label>
      </div>
